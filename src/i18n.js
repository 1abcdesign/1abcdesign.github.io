...
const messages = {
  en: {
    moto: 'From «A-B-C» to «All-Turnkey» Design!',
    ...
    aboutUs21: 'We see the world as a grand Design — a masterpiece crafted by the universal energy that began with Design, exists through Design, and will end in Design (and of course, Love ',
  ...
  uk: {
    moto: 'Від «А-Б-Ц» до «Під-ключ-Все» Дизайн!',
    ...
    b00: 'Втілення Ξ Екстер’єр',
    c00: 'Створення Ξ Інтер’єр',
    ...
    aboutUs21: 'Ми бачимо цей світ як велике творіння, яке відображає задум Творця — усе почалося з Дизайну, втілюється в Дизайні та завершиться Дизайном (ну і Любов’ю, звісно ж ',
