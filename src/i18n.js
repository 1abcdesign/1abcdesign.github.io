...
const messages = {
  en: {
    ...
    form_project_ph: 'Interior design of a new house',
    form_budget: 'BUDGET (in UAH ₴)',
    form_comment: 'COMMENT',
    form_comment_ph: 'Call me back between 10AM and 16PM any day',
    form_send: 'SEND',
    ambience: 'Ambience',
    building: 'Building',
    crafting: 'Crafting',
  ...
  uk: {
    ...
    form_email: 'ПОШТА',
    form_project: 'ПРОЕКТ',
    form_project_ph: 'Дизайн інтер’єру нового будинку',
    form_budget: 'БЮДЖЕТ (в грн ₴)',
    form_comment: 'КОМЕНТАР',
    form_comment_ph: 'Передзвоніть з 10:00 до 16:00 у будь-який день',
    form_send: 'НАДІСЛАТИ',
    ambience: 'Атмосфера',
    building: 'Втілення',
    crafting: 'Створення',
