import{Z as p,b as f}from"./vendor-CTozpBxZ.js";import{f as d}from"./flatPhotos-BJH0RvRV.js";import{_ as g}from"./index-C9q_itWk.js";import{r as _,b as l,f as i,w as b,c as v,F as $,y as k,C as u}from"./vue-CSzecv1Y.js";const w=(c,a=10)=>{const r=[];for(let e=0;e<c.length;e+=a)r.push(c.slice(e,e+a));return r},o=w(d),x={__name:"ServicesSlider",setup(c){const a="https://1abcdesign.github.io/";o.forEach(t=>t.sort(()=>Math.random()-.5));const r=[],e=Math.max(...o.map(t=>t.length));for(let t=0;t<e;t++)for(let s=0;s<o.length;s++)o[s][t]&&r.push(o[s][t]);const m=_(r.map(t=>({group:`${t.charAt(0)+"00"}`,title:`${t.slice(0,3)+"_title"}`,content:`<div style="background-image: url('${a}${t}');
