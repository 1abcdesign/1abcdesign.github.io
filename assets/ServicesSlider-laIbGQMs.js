import{Z as p,b as f}from"./vendor-CR05li1N.js";import{f as d}from"./flatPhotos-BJH0RvRV.js";import{_ as g}from"./index-DIkC_roI.js";import{s as _,o as l,c as i,w as b,a as v,F as $,p as k,C as u}from"./vue-DWba8sbm.js";const w=(c,a=10)=>{const s=[];for(let e=0;e<c.length;e+=a)s.push(c.slice(e,e+a));return s},r=w(d),x={__name:"ServicesSlider",setup(c){const a="https://1abcdesign.github.io/";r.forEach(t=>t.sort(()=>Math.random()-.5));const s=[],e=Math.max(...r.map(t=>t.length));for(let t=0;t<e;t++)for(let o=0;o<r.length;o++)r[o][t]&&s.push(r[o][t]);const m=_(s.map(t=>({group:`${t.charAt(0)+"00"}`,title:`${t.slice(0,3)+"_title"}`,content:`<div style="background-image: url('${a}${t}');
